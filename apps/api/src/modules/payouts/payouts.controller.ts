 ...
 *
 * Two endpoints and no more: ask for money, and see what happened to the
 * asking. Cancelling is deliberately absent — a request an admin may already
 * be part-way through paying is not the user's to withdraw, and "I cancelled
 * but you paid anyway" is a dispute with no good answer.
 *
